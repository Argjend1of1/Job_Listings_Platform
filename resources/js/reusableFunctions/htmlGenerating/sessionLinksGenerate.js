...
export function employerLinks(employer)  {
    return `
...
export function adminLinks(employer) {
    return `
                <div class="relative" id="profileDropdown">
                    <img id="dropdownButton"
                        src="${employer?.logo ? `/${employer?.logo}` : '/default-profile.png'}"
                    ...
                    <div id="dropdownMenu"
                        ...
                        <a href="/api/users" id="userDashboard" class="block border-b border-b-gray-800 px-4 py-2 text-white hover:bg-gray-800 focus:bg-gray-900">Users</a>
                        <button id="logoutBtn" class="w-full text-left block px-4 py-2 text-red-400 hover:bg-red-900 cursor-pointer focus:bg-red-950">Log Out</button>
                    </div>
                </div>
            `
